            ...
            <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/60 rounded-2xl p-8 shadow-2xl relative z-10 transition-all hover:border-slate-700/60">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`w-full bg-cyan-600 hover:bg-cyan-500 text-white font-medium py-3 px-4 rounded-lg shadow-lg shadow-cyan-900/20 transition-all ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:scale-[1.02]'}`}
                    >
