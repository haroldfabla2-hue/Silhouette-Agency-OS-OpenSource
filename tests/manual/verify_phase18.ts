// =============================================================================
// MANUAL INTEGRATION PROBE — Phase 18 (Browser + Self-Healing)
// ─────────────────────────────────────────────────────────────────────────────
// NOT a Vitest suite: this requires a real Playwright browser and network
// access, and calls process.exit(). Run manually with:
//   npx tsx tests/manual/verify_phase18.ts
// =============================================================================
